...
$app->post('/api/AmazonRedshift/createSnapshotCopyGrant', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'snapshotCopyGrantName']);
    ...
    try {
        $res = $client->createSnapshotCopyGrant($body)->toArray();
