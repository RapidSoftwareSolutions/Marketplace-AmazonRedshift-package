...
$app->post('/api/AmazonRedshift/describeTableRestoreStatus', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['tableRestoreRequestId'])) {
        $body['TableRestoreRequestId'] = $post_data['args']['tableRestoreRequestId'];
    }

    try {
        $res = $client->describeTableRestoreStatus($body)->toArray();
