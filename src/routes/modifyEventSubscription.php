...
$app->post('/api/AmazonRedshift/modifyEventSubscription', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'subscriptionName']);
    ...
    if(!empty($post_data['args']['snsTopicArn'])) {
    ...
    try {
        $res = $client->modifyEventSubscription($body)->toArray();
