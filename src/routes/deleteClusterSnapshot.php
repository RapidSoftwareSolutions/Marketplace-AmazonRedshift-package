...
$app->post('/api/AmazonRedshift/deleteClusterSnapshot', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'snapshotIdentifier']);
    ...
    try {
        $res = $client->deleteClusterSnapshot($body)->toArray();
