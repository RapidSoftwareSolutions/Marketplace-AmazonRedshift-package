...
$app->post('/api/AmazonRedshift/describeEventSubscriptions', function ($request, $response, $args) {
    ...
    $body = [];
    if(!empty($post_data['args']['subscriptionName'])) {
    ...
    try {
        $res = $client->describeEventSubscriptions($body)->toArray();
