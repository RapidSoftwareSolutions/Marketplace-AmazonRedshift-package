...
$app->post('/api/AmazonRedshift/describeReservedNodes', function ($request, $response, $args) {
    ...
    $body = [];
    if(!empty($post_data['args']['reservedNodeId'])) {
        $body['ReservedNodeId'] = $post_data['args']['reservedNodeId'];
    }
    ...
    try {
        $res = $client->describeReservedNodes($body)->toArray();
