...
$app->post('/api/AmazonRedshift/describeClusterSecurityGroups', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['clusterSecurityGroupName'])) {
    ...
    try {
        $res = $client->describeClusterSecurityGroups($body)->toArray();
